...
package dev.tclark.dogshow.apps.android.util;
...
import dev.tclark.dogshow.apps.android.preferences.Prefs;
import dev.tclark.dogshow.apps.android.ui.AccountActivity;
...
//                        activityRequestCode),
//                null);
        AccountManager.get(activity).getAuthToken(account, AUTH_TOKEN_TYPE, null, activity, getAccountManagerCallback(callback, account, activity, activity, activityRequestCode), null);
    }
