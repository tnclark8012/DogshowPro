...
public class DogshowDatabase extends SQLiteOpenHelper {
	...
	private void createHandlersTable(SQLiteDatabase db) {
		db.execSQL("CREATE TABLE " + Tables.HANDLERS + " (" + BaseColumns._ID
				...
				+ " INTEGER DEFAULT 1," + SyncColumns.UPDATED
				+ " LONG DEFAULT 0)");
	}
	...
	private void createShowTeamsTable(SQLiteDatabase db) {
		db.execSQL("CREATE TABLE " + Tables.SHOW_TEAMS + " (" + BaseColumns._ID
				...
				+ ShowTeams.ENTERED_SHOW + " TEXT," + ShowTeams.UPDATED
				+ " LONG DEFAULT 0)");
		// db.execSQL("INSERT INTO " + Tables.SHOW_TEAMS + " (" +
		// ShowTeams.SHOW_TEAM_ID + ", " + ShowTeams.SHOW_TEAM_NAME + "," +
		// ShowTeams.SHOW_TEAM_STATE + ", " + ShowTeams.SHOW_TEAM_ACTIVE + ", "
		// + ShowTeams.SHOW_TEAM_JUST_ME +
		// ") VALUES (\"ME\", \"Just Me\", 1,1,1)");
	}
	...
	private void createJuniorsRingsTable(SQLiteDatabase db) {
		db.execSQL("CREATE TABLE " + Tables.JUNIORS_RINGS + " ("
				+ BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
				+ RingColumns.RING_BLOCK_START + " INTEGER NOT NULL,"
				+ JuniorsRingsColumns.RING_JUNIOR_CLASS_NAME
				+ " TEXT NOT NULL," + JuniorsRingsColumns.RING_JUNIOR_COUNT
				+ " INTEGER NOT NULL," + RingColumns.RING_COUNT_AHEAD
				+ " INTEGER NOT NULL," + RingColumns.RING_DATE
				+ " INTEGER NOT NULL," + RingColumns.RING_JUDGE
				+ " TEXT NOT NULL," + RingColumns.RING_JUDGE_TIME + " INTEGER,"
				+ RingColumns.RING_NUMBER + " INTEGER NOT NULL,"
				+ RingColumns.RING_SHOW_ID + " TEXT NOT NULL,"
				+ RingColumns.RING_TITLE + " TEXT,"
