					...
					new AsyncTask<String, Void, ShowTeamResponse>() {// TODO move me outside
						...
						protected ShowTeamResponse doInBackground(String... params) {
							if (mMode == MODE_CREATE) {
								return ApiAccessor.getInstance().createShowTeam(AccountUtils.getUserId(getActivity()), params[0], params[1]);
							} else {
								return ApiAccessor.getInstance().joinShowTeam(AccountUtils.getUserId(getActivity()), params[0], params[1]);
							}
						}
