...
public class Query {
	...
	public interface RingsQuery {
		...
		String[] PROJECTION = { 
				...
				EnteredRings.ENTERED_RINGS_SPECIAL_DOG_COUNT, EnteredRings.ENTERED_RINGS_SPECIAL_BITCH_COUNT };
		int _ID = 0;
		int BLOCK_START = 1;
		int COUNT_AHEAD = 2;
		int IMAGE_PATH = 3;
	...
	public interface DogSyncQuery {
		int _TOKEN = 0x5;
		final String[] PROJECTION = { Dogs._ID, Dogs.DOG_BREED, Dogs.DOG_CALL_NAME, Dogs.DOG_CLASS, Dogs.DOG_IS_CHAMPION, Dogs.DOG_IS_SHOWING, Dogs.DOG_IS_SHOWING_SWEEPSTAKES, Dogs.DOG_IS_VETERAN, Dogs.DOG_MAJORS, Dogs.DOG_POINTS, Dogs.DOG_SEX, Dogs.DOG_UPDATED, Dogs.DOG_ID };
