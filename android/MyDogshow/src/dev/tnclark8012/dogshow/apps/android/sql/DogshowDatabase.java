...
public class DogshowDatabase extends SQLiteOpenHelper {
	...
	public interface Tables {
		...
		String ENTERED_DOGS_BY_BREED = "(SELECT *, " + Dogs.DOG_BREED + " as " + Dogs.ENTERED_DOGS_BREED + ", group_concat(" + Qualified.DOG_CALL_NAME + ", \", \" ) as " + Dogs.ENTERED_DOGS_NAMES + " FROM " + Tables.DOGS + " GROUP BY " + Dogs.DOG_BREED + "," + Dogs.DOG_IS_SHOWING_SWEEPSTAKES + ", " +Dogs.DOG_IS_VETERAN +")";
		...
		String ENTERED_BREED_RINGS_JOIN_DOGS_JOIN_ON = Qualified.BREED_RINGS_RING_BREED + "=" + Dogs.ENTERED_DOGS_BREED + " AND " + Qualified.BREED_RINGS_IS_SWEEPSTAKES + "=" + Dogs.DOG_IS_SHOWING_SWEEPSTAKES + " AND " + Qualified.BREED_RINGS_IS_VETERAN + "=" + Dogs.DOG_IS_VETERAN;
		String ENTERED_BREED_RINGS_JOIN_DOGS = "(" + BREED_RINGS + " " + "JOIN " + ENTERED_DOGS_BY_BREED
				+ " as entered_breed_rings_dogs ON " +ENTERED_BREED_RINGS_JOIN_DOGS_JOIN_ON + ")";			
    ...
    private void insertDebugEntities(SQLiteDatabase db)
    {
        ...
        db.execSQL("INSERT INTO " + Tables.DOGS + " (" + DogsColumns.DOG_BREED
                ...
                + ")" + " VALUES (" + "\"GERMAN_SHEPHERD_DOG\"," + "\"German(V/S)\"," + "2,"
                + "0," + "20," + "1," + "1," + System.currentTimeMillis() + ",1,1)");
        db.execSQL("INSERT INTO " + Tables.DOGS + " (" + DogsColumns.DOG_BREED
                + "," + DogsColumns.DOG_CALL_NAME + ","
                + DogsColumns.DOG_MAJORS + "," + DogsColumns.DOG_OWNER_ID + ","
                + DogsColumns.DOG_POINTS + "," + DogsColumns.DOG_SEX + ","
                + DogsColumns.DOG_IS_SHOWING + "," + DogsColumns.DOG_UPDATED+ ","
                + DogsColumns.DOG_IS_SHOWING_SWEEPSTAKES + "," + DogsColumns.DOG_IS_VETERAN
                + ")" + " VALUES (" + "\"GERMAN_SHEPHERD_DOG\"," + "\"German (S)\"," + "2,"
                + "0," + "20," + "1," + "1," + System.currentTimeMillis() + ",1,0)");
        ...
        db.execSQL("INSERT INTO " + Tables.DOGS + " (" + DogsColumns.DOG_BREED
                ...
                + DogsColumns.DOG_IS_SHOWING + "," + DogsColumns.DOG_UPDATED+ ","
                + DogsColumns.DOG_IS_SHOWING_SWEEPSTAKES + "," + DogsColumns.DOG_IS_VETERAN
                + ")" + " VALUES (" + "\"GERMAN_SHEPHERD_DOG\"," + "\"Boring German\"," + "2,"
                + "0," + "20," + "1," + "1," + System.currentTimeMillis() + ",0,0)");
        db.execSQL("INSERT INTO " + Tables.DOGS + " (" + DogsColumns.DOG_BREED
                + "," + DogsColumns.DOG_CALL_NAME + ","
                + DogsColumns.DOG_MAJORS + "," + DogsColumns.DOG_OWNER_ID + ","
                + DogsColumns.DOG_POINTS + "," + DogsColumns.DOG_SEX + ","
                + DogsColumns.DOG_IS_SHOWING + "," + DogsColumns.DOG_UPDATED+ ","
                + DogsColumns.DOG_IS_SHOWING_SWEEPSTAKES + "," + DogsColumns.DOG_IS_VETERAN
                + ")" + " VALUES (" + "\"SHETLAND_SHEEPDOG\"," + "\"Jay (V/S)\"," + "2,"
                + "0," + "20," + "1," + "1," + System.currentTimeMillis() + ",1,1)");
        db.execSQL("INSERT INTO " + Tables.DOGS + " (" + DogsColumns.DOG_BREED
                + "," + DogsColumns.DOG_CALL_NAME + ","
                + DogsColumns.DOG_MAJORS + "," + DogsColumns.DOG_OWNER_ID + ","
                ...
                + DogsColumns.DOG_IS_SHOWING + "," + DogsColumns.DOG_UPDATED+ ","
                + DogsColumns.DOG_IS_SHOWING_SWEEPSTAKES + "," + DogsColumns.DOG_IS_VETERAN
                + ")" + " VALUES (" + "\"SHETLAND_SHEEPDOG\"," + "\"Jason (S)\"," + "2,"
                + "0," + "20," + "1," + "1," + System.currentTimeMillis() + ",1,0)");
