...
public class AppEngineBreedRingsHandler extends JsonHandler {
	boolean clearExisting = false;
	boolean hasCleared = false;

	protected AppEngineBreedRingsHandler(Context context, boolean clearExisting) {
		super(context);
		this.clearExisting = clearExisting;
	}

	private static final String TAG = AppEngineBreedRingsHandler.class.getSimpleName();
