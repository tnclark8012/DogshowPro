...
public class BreedRingsHandler extends JsonHandler {
	...
	public ArrayList<ContentProviderOperation> parse(String showId, long dateMillis, String judge, int ringNumber, long blockStartMillis, int count, String breedName, int dogCount, int bitchCount, int specialDog, int specialBitch, int countAhead) {
		ArrayList<ContentProviderOperation> batch = new ArrayList<ContentProviderOperation>();
		ContentProviderOperation.Builder builder = null;
		Log.v(TAG, "new ring");
		builder = ContentProviderOperation.newInsert(DogshowContract.addCallerIsSyncAdapterParameter(BreedRings.CONTENT_URI));
