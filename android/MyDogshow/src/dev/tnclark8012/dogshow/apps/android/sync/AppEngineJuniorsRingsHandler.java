...
public class AppEngineJuniorsRingsHandler extends JsonHandler {
	boolean clearExisting = false;
	boolean hasCleared = false;

	protected AppEngineJuniorsRingsHandler(Context context, boolean clearExisting) {
		super(context);
		this.clearExisting = clearExisting;
	}

	private static final String TAG = AppEngineJuniorsRingsHandler.class.getSimpleName();
