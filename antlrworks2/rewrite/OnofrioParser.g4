...
inner_timeblock 
    ...
    : (
        (
            (mName=judge_name{mCurrentJudge = $mName.json; judgeSet.add($mName.json.get("Judge").getAsString());})? //there may not be a new time block when judges change. See ANOK1 Saturday, Ring 3
