...
public class FindShowFragment extends ListFragment {
    ...
    public void setEmptyText(CharSequence text) {
        getListView().setEmptyView(EmptyView.getEmptySyncView(getActivity(), text));
    }
            ...
            if (show != null) {
                if (show.hasSchedule) {
                    ((TextView) convertView.findViewById(android.R.id.text1))
                            .setText(show.location);
                } else {
                    ((TextView) convertView.findViewById(android.R.id.text1))
                            .setText(getResources().getString(R.string.show_location_pdf_only, show.location));
                }
                ((TextView) convertView.findViewById(android.R.id.text2))
                        .setText(show.showName);
            }
            return convertView;
        }
    }
